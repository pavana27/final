...
?>
		<form action="php/register2.php" method="get" class="col form-signin">
		  <img class="mb-4" src="https://getbootstrap.com/docs/4.0/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">
		  ...
		  <div id="messageRegister" class="alert alert-info mt-2" role="alert"><?php echo $_SESSION["Message"];?></div>
...
?>
		<form action="php/resetPassword2.php" method="get" class="col form-signin">
		  <img class="mb-4" src="https://getbootstrap.com/docs/4.0/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">
		  ...
		  <input type="email" id="inputEmail" name="Email" class="form-control" placeholder="Registered email address" required autofocus>
		  <button type="submit" class="btn btn-lg btn-primary btn-block" type="submit">Authenticate</button>
		  <div id="messageResetPassword" class="alert alert-info mt-2" role="alert"><?php echo $_SESSION["Message"]; ?></div>
		  <a href="php/clearAll.php"><button type="button" class="mt-2">Return</button></a>
		</form>
<?php
	}
...
?>
		<form action="php/setPassword.php" method="post" class="col form-signin">
		  ...
		  <input type="hidden" id="inputEmail" name="Email" class="form-control" value="<?php echo $_SESSION["Email"]; ?>">
		  ...
		  <div id="messageSetPassword" class="alert alert-info mt-2" role="alert"><?php echo $_SESSION["Message"]; ?></div>
